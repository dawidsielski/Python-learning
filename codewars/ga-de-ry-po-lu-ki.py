...
print(encode("Gug hgs g cgt","gaderypoluki") == "Ala has a cat")
print(decode("agedyropulik","gaderypoluki") == "gaderypoluki")
print(encode("Dkucr pu yhr ykbir","politykarenu") == "Dance on the table")
